    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                #region Default
                //usuario = db.Usuario.FirstOrDefault(m => m.nombre_usuario == model.UserName);
                //usuario = await db.Usuario.FindAsync(model.UserName);
                ...
                if (usuario != null)
                {
                   this.SignInUser(usuario.nombre_usuario,false);
